...
{
    public static IServiceCollection AddInstantAPIs(this IServiceCollection services,
        Action<InstantAPIsServiceOptions>? setupAction = null)
    {
        ...
        if (options.EnableSwagger == null) options.EnableSwagger = EnableSwagger.DevelopmentOnly;
        ...
        services.Configure<InstantAPIsServiceOptions>(config => { config.EnableSwagger = options.EnableSwagger; });
